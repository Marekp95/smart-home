...
test_cases = [
    ...
    ('Załącz lampy nad Oławą na poddaszu', 'on A7'),
    ('Wyłącz lampę nad ławą na poddaszu', 'off A7'),
    ('lampa nad Oławą', 'xchg A7'),
    ...
    ('Załącz lampy lewo w sypialni', 'on B2'),
    ...
    ('sypialnia załącza oświetlenie za telewizorem', 'on B6'),
    ...
    ('łazienka Wyłącz lampy nad lustrem', 'off C2'),
    ...
    ('Załóż dmuchawę w łazience', 'error'),
    ('Załącz dmuchawy w łazience', 'on C4'),
    ...
    ('Załóż oświetlenie pod szafkami w kuchni', 'error'),
